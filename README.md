...
[![test](https://github.com/hazcod/plextrac-go/actions/workflows/test.yml/badge.svg)](https://github.com/hazcod/plextrac-go/actions/workflows/test.yml)
[![lint](https://github.com/hazcod/plextrac-go/actions/workflows/lint.yml/badge.svg)](https://github.com/hazcod/plextrac-go/actions/workflows/lint.yml)
[![security](https://github.com/hazcod/plextrac-go/actions/workflows/security.yml/badge.svg)](https://github.com/hazcod/plextrac-go/actions/workflows/security.yml)
[![Go Reference](https://pkg.go.dev/badge/github.com/hazcod/plextrac-go.svg)](https://pkg.go.dev/github.com/hazcod/plextrac-go)
[![Go Report Card](https://goreportcard.com/badge/github.com/hazcod/plextrac-go)](https://goreportcard.com/report/github.com/hazcod/plextrac-go)

Go SDK and CLI for the [Plextrac](https://plextrac.com) pentest reporting platform.

- **SDK**: `github.com/hazcod/plextrac-go/pkg/plextrac` — typed client for flaws, clients, reports, assets, writeups, attachments, templates, tags, users, and exports.
...
```bash
go get github.com/hazcod/plextrac-go/pkg/plextrac@latest
```

### CLI

Download a release binary from the [Releases page](https://github.com/hazcod/plextrac-go/releases), or build from source:

```bash
go install github.com/hazcod/plextrac-go/cmd/plextrac@latest
```
